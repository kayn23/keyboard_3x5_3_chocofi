...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
								  LSFT_T(KC_ESC), T_BASE_H_NAV,       KC_ENT,  RCMD_T(KC_SPC),T_MEDIA_H_SYM,      KC_BSPC \
								//|-------------+-------------+-------------|  |-------------+-------------+-------------|
	),
	...
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	          KC_F11,       KC_F12,       KC_F13,       KC_F14,       KC_F15,      KC_MS_LEFT,   KC_MS_DOWN,     KC_MS_UP,  KC_MS_RIGHT,          KC_NO, \
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
	           KC_NO,        KC_NO,   KC_MS_BTN2,   KC_MS_BTN1,        KC_NO,           KC_NO,      KC_WH_D,      KC_WH_U,      KC_WH_L,        KC_WH_R, \
	//|-------------+-------------+-------------+-------------+-------------|  |-------------+-------------+-------------+-------------+---------------|
